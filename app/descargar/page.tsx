...
const APK_URL = 'https://pnesuibfgtescgudkerf.supabase.co/storage/v1/object/public/expedientes/app/Credicabs%20v1.4.apk';
        ...
        <section className="pt-32 pb-20 px-6 text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <a href={APK_URL} download="credicabs.apk"
              ...
              Descargar APK
              <span className="text-xs font-bold opacity-60 ml-1">v1.4 · 21 MB</span>
            </a>
